...
@SuppressWarnings("all") public class JHamlLexer extends Lexer {
    ...
    traceIn("ATTRIBUTE_NAME", 7);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:125:15: ({...}? => ':' ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
            // ../etc/JHaml.g:125:19: {...}? => ':' ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
            ...
            // ../etc/JHaml.g:126:27: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    traceIn("ID", 9);
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:132:3: ({...}? => ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
            // ../etc/JHaml.g:132:7: {...}? => ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            {
            ...
            // ../etc/JHaml.g:133:23: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    traceIn("INDENTATION", 10);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:136:13: ({...}? => ( Space )+ )
            // ../etc/JHaml.g:136:15: {...}? => ( Space )+
            {
    ...
    traceIn("WS_WITHIN_HASH", 12);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:142:16: ({...}? => Space )
            // ../etc/JHaml.g:142:18: {...}? => Space
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("NEWLINE", 14);
        try {
            int _type = NEWLINE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:148:10: ({...}? => NL )
            // ../etc/JHaml.g:148:12: {...}? => NL
            {
            if ( !(( lineMode != EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("IGNORED_NEWLINE", 15);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:149:18: ({...}? => NL )
            // ../etc/JHaml.g:149:20: {...}? => NL
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("HEX_LITERAL", 17);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:152:13: ({...}? => '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )? )
            // ../etc/JHaml.g:152:15: {...}? => '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )?
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
            ...
            // ../etc/JHaml.g:152:80: ( INTEGER_TYPE_SUFFIX )?
            int alt7=2;
    ...
    traceIn("DECIMAL_LITERAL", 18);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:154:17: ({...}? => ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )? )
            // ../etc/JHaml.g:154:19: {...}? => ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )?
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
                throw new FailedPredicateException(input, "DECIMAL_LITERAL", " lineMode == EMode.ATTRIBUTE_HASH ");
            }
            // ../etc/JHaml.g:154:59: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ../etc/JHaml.g:154:66: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // ../etc/JHaml.g:154:75: ( '0' .. '9' )*
                    loop8:
                    do {
                        int alt8=2;
            ...
            // ../etc/JHaml.g:154:86: ( INTEGER_TYPE_SUFFIX )?
            int alt10=2;
    ...
    traceIn("OCTAL_LITERAL", 19);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:156:15: ({...}? => '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )? )
            // ../etc/JHaml.g:156:17: {...}? => '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )?
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
                throw new FailedPredicateException(input, "OCTAL_LITERAL", " lineMode == EMode.ATTRIBUTE_HASH ");
            }
            match('0'); 
            // ../etc/JHaml.g:156:61: ( '0' .. '7' )+
            int cnt11=0;
            loop11:
            do {
                int alt11=2;
            ...
            // ../etc/JHaml.g:156:73: ( INTEGER_TYPE_SUFFIX )?
            int alt12=2;
    ...
    traceIn("HEX_DIGIT", 20);
        try {
            // ../etc/JHaml.g:159:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // ../etc/JHaml.g:159:13: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    traceIn("INTEGER_TYPE_SUFFIX", 21);
        try {
            // ../etc/JHaml.g:162:21: ( ( 'l' | 'L' ) )
            // ../etc/JHaml.g:162:23: ( 'l' | 'L' )
            {
    ...
    traceIn("TRUE", 22);
        try {
            int _type = TRUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:164:5: ({...}? => 'true' )
            // ../etc/JHaml.g:164:7: {...}? => 'true'
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("FALSE", 23);
        try {
            int _type = FALSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:165:6: ({...}? => 'false' )
            // ../etc/JHaml.g:165:8: {...}? => 'false'
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("NULL", 24);
        try {
            int _type = NULL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:166:5: ({...}? => 'null' )
            // ../etc/JHaml.g:166:7: {...}? => 'null'
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("FLOATING_POINT_LITERAL", 25);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:169:5: ({...}? => ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX ) | DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? )
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // ../etc/JHaml.g:169:7: {...}? => ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                    {
                    if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
                        throw new FailedPredicateException(input, "FLOATING_POINT_LITERAL", " lineMode == EMode.ATTRIBUTE_HASH ");
                    }
                    // ../etc/JHaml.g:170:9: ( '0' .. '9' )+
                    int cnt13=0;
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    // ../etc/JHaml.g:171:9: ( '.' ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                    int alt18=3;
                    switch ( input.LA(1) ) {
                    case '.':
                        {
                    ...
                    switch (alt18) {
                        case 1 :
                            // ../etc/JHaml.g:172:13: '.' ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                            {
                            match('.'); 
                            // ../etc/JHaml.g:172:17: ( '0' .. '9' )*
                            loop14:
                            do {
                                int alt14=2;
                            ...
                            // ../etc/JHaml.g:172:39: ( FLOAT_TYPE_SUFFIX )?
                            int alt16=2;
                            ...
                            break;
                        case 2 :
                            // ../etc/JHaml.g:173:13: EXPONENT ( FLOAT_TYPE_SUFFIX )?
                            {
                            mEXPONENT(); 
                            // ../etc/JHaml.g:173:22: ( FLOAT_TYPE_SUFFIX )?
                            int alt17=2;
                            ...
                            break;
                        case 3 :
                            // ../etc/JHaml.g:174:13: FLOAT_TYPE_SUFFIX
                            {
                            mFLOAT_TYPE_SUFFIX(); 
                    ...
                    break;
                case 2 :
                    // ../etc/JHaml.g:176:9: DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                    {
                    mDOT(); 
                    // ../etc/JHaml.g:176:13: ( '0' .. '9' )+
                    int cnt19=0;
                    loop19:
                    do {
                        int alt19=2;
                    ...
                    // ../etc/JHaml.g:176:35: ( FLOAT_TYPE_SUFFIX )?
                    int alt21=2;
    ...
    traceIn("FLOAT_TYPE_SUFFIX", 26);
        try {
            // ../etc/JHaml.g:180:19: ( ( 'f' | 'F' | 'd' | 'D' ) )
            // ../etc/JHaml.g:180:21: ( 'f' | 'F' | 'd' | 'D' )
            {
    ...
    traceIn("EXPONENT", 27);
        try {
            // ../etc/JHaml.g:183:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // ../etc/JHaml.g:183:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    traceIn("CHAR_LITERAL", 28);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:187:5: ({...}? => '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )* '\\'' )
            // ../etc/JHaml.g:187:7: {...}? => '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )* '\\''
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
                throw new FailedPredicateException(input, "CHAR_LITERAL", " lineMode == EMode.ATTRIBUTE_HASH ");
            }
            match('\''); 
            // ../etc/JHaml.g:187:52: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )*
            loop25:
            do {
                int alt25=3;
                ...
                switch (alt25) {
            	case 1 :
            	    // ../etc/JHaml.g:187:54: EscapeSequence
            	    {
            	    mEscapeSequence(); 
    ...
    traceIn("STRING_LITERAL", 29);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:191:5: ({...}? => '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"' )
            // ../etc/JHaml.g:191:7: {...}? => '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
                throw new FailedPredicateException(input, "STRING_LITERAL", " lineMode == EMode.ATTRIBUTE_HASH ");
            }
            match('\"'); 
            // ../etc/JHaml.g:191:51: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
            loop26:
            do {
                int alt26=3;
                ...
                switch (alt26) {
            	case 1 :
            	    // ../etc/JHaml.g:191:53: EscapeSequence
            	    {
            	    mEscapeSequence(); 
    ...
    traceIn("EscapeSequence", 30);
        try {
            // ../etc/JHaml.g:195:15: ( '\\\\' ~ NL )
            // ../etc/JHaml.g:195:17: '\\\\' ~ NL
            {
            match('\\'); 
    ...
    traceIn("TEXT", 31);
        try {
            int _type = TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:197:5: ( ( TextLine | InLineText )? ( RemainderOfLineText )? )
            // ../etc/JHaml.g:197:7: ( TextLine | InLineText )? ( RemainderOfLineText )?
            {
            // ../etc/JHaml.g:197:7: ( TextLine | InLineText )?
            int alt27=3;
            ...
            // ../etc/JHaml.g:197:32: ( RemainderOfLineText )?
            int alt28=2;
    ...
    traceIn("TextLine", 33);
        try {
            int _type = TextLine;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:201:9: ({...}? => (~ ( '.' | '#' | '%' | NL | Space ) ) )
            // ../etc/JHaml.g:201:11: {...}? => (~ ( '.' | '#' | '%' | NL | Space ) )
            {
            if ( !(( lineMode == EMode.BEGINNING )) ) {
                throw new FailedPredicateException(input, "TextLine", " lineMode == EMode.BEGINNING ");
            }
            // ../etc/JHaml.g:202:3: (~ ( '.' | '#' | '%' | NL | Space ) )
            // ../etc/JHaml.g:202:4: ~ ( '.' | '#' | '%' | NL | Space )
            {
    ...
    traceIn("JAVA_LBRACE", 37);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:211:13: ({...}? => LBRACE )
            // ../etc/JHaml.g:211:15: {...}? => LBRACE
            {
            if ( !(( lineMode == EMode.ATTRIBUTE_HASH )) ) {
    ...
    traceIn("JAVA_RBRACE", 38);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/JHaml.g:212:13: ({...}? => RBRACE )
            // ../etc/JHaml.g:212:15: {...}? => RBRACE
            {
            if ( !(( braceDepth > 1 )) ) {
