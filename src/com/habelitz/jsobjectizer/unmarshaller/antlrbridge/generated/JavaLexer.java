// $ANTLR 3.2 Sep 23, 2009 12:02:23 ../etc/Java.g 2010-02-26 10:16:37
...
public class JavaLexer extends Lexer {
    ...
    public String getGrammarFileName() { return "../etc/Java.g"; }
    ...
    traceIn("ABSTRACT", 50);
        try {
            int _type = ABSTRACT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:68:10: ( 'abstract' )
            // ../etc/Java.g:68:12: 'abstract'
            {
            match("abstract"); 
    ...
    traceIn("ASSERT", 51);
        try {
            int _type = ASSERT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:69:8: ( 'assert' )
            // ../etc/Java.g:69:10: 'assert'
            {
            match("assert"); 
    ...
    traceIn("BOOLEAN", 52);
        try {
            int _type = BOOLEAN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:70:9: ( 'boolean' )
            // ../etc/Java.g:70:11: 'boolean'
            {
            match("boolean"); 
    ...
    traceIn("BREAK", 53);
        try {
            int _type = BREAK;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:71:7: ( 'break' )
            // ../etc/Java.g:71:9: 'break'
            {
            match("break"); 
    ...
    traceIn("BYTE", 54);
        try {
            int _type = BYTE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:72:6: ( 'byte' )
            // ../etc/Java.g:72:8: 'byte'
            {
            match("byte"); 
    ...
    traceIn("CASE", 55);
        try {
            int _type = CASE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:73:6: ( 'case' )
            // ../etc/Java.g:73:8: 'case'
            {
            match("case"); 
    ...
    traceIn("CATCH", 56);
        try {
            int _type = CATCH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:74:7: ( 'catch' )
            // ../etc/Java.g:74:9: 'catch'
            {
            match("catch"); 
    ...
    traceIn("CHAR", 57);
        try {
            int _type = CHAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:75:6: ( 'char' )
            // ../etc/Java.g:75:8: 'char'
            {
            match("char"); 
    ...
    traceIn("CLASS", 58);
        try {
            int _type = CLASS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:76:7: ( 'class' )
            // ../etc/Java.g:76:9: 'class'
            {
            match("class"); 
    ...
    traceIn("CONTINUE", 59);
        try {
            int _type = CONTINUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:77:10: ( 'continue' )
            // ../etc/Java.g:77:12: 'continue'
            {
            match("continue"); 
    ...
    traceIn("DEFAULT", 60);
        try {
            int _type = DEFAULT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:78:9: ( 'default' )
            // ../etc/Java.g:78:11: 'default'
            {
            match("default"); 
    ...
    traceIn("DOUBLE", 62);
        try {
            int _type = DOUBLE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:80:8: ( 'double' )
            // ../etc/Java.g:80:10: 'double'
            {
            match("double"); 
    ...
    traceIn("ELSE", 63);
        try {
            int _type = ELSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:81:6: ( 'else' )
            // ../etc/Java.g:81:8: 'else'
            {
            match("else"); 
    ...
    traceIn("ENUM", 64);
        try {
            int _type = ENUM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:82:6: ( 'enum' )
            // ../etc/Java.g:82:8: 'enum'
            {
            match("enum"); 
    ...
    traceIn("EXTENDS", 65);
        try {
            int _type = EXTENDS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:83:9: ( 'extends' )
            // ../etc/Java.g:83:11: 'extends'
            {
            match("extends"); 
    ...
    traceIn("FALSE", 66);
        try {
            int _type = FALSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:84:7: ( 'false' )
            // ../etc/Java.g:84:9: 'false'
            {
            match("false"); 
    ...
    traceIn("FINAL", 67);
        try {
            int _type = FINAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:85:7: ( 'final' )
            // ../etc/Java.g:85:9: 'final'
            {
            match("final"); 
    ...
    traceIn("FINALLY", 68);
        try {
            int _type = FINALLY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:86:9: ( 'finally' )
            // ../etc/Java.g:86:11: 'finally'
            {
            match("finally"); 
    ...
    traceIn("FLOAT", 69);
        try {
            int _type = FLOAT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:87:7: ( 'float' )
            // ../etc/Java.g:87:9: 'float'
            {
            match("float"); 
    ...
    traceIn("IMPLEMENTS", 72);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:90:12: ( 'implements' )
            // ../etc/Java.g:90:14: 'implements'
            {
            match("implements"); 
    ...
    traceIn("INSTANCEOF", 73);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:91:12: ( 'instanceof' )
            // ../etc/Java.g:91:14: 'instanceof'
            {
            match("instanceof"); 
    ...
    traceIn("INTERFACE", 74);
        try {
            int _type = INTERFACE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:92:11: ( 'interface' )
            // ../etc/Java.g:92:13: 'interface'
            {
            match("interface"); 
    ...
    traceIn("IMPORT", 75);
        try {
            int _type = IMPORT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:93:8: ( 'import' )
            // ../etc/Java.g:93:10: 'import'
            {
            match("import"); 
    ...
    traceIn("LONG", 77);
        try {
            int _type = LONG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:95:6: ( 'long' )
            // ../etc/Java.g:95:8: 'long'
            {
            match("long"); 
    ...
    traceIn("NATIVE", 78);
        try {
            int _type = NATIVE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:96:8: ( 'native' )
            // ../etc/Java.g:96:10: 'native'
            {
            match("native"); 
    ...
    traceIn("NULL", 80);
        try {
            int _type = NULL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:98:6: ( 'null' )
            // ../etc/Java.g:98:8: 'null'
            {
            match("null"); 
    ...
    traceIn("PACKAGE", 81);
        try {
            int _type = PACKAGE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:99:9: ( 'package' )
            // ../etc/Java.g:99:11: 'package'
            {
            match("package"); 
    ...
    traceIn("PRIVATE", 82);
        try {
            int _type = PRIVATE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:100:9: ( 'private' )
            // ../etc/Java.g:100:11: 'private'
            {
            match("private"); 
    ...
    traceIn("PROTECTED", 83);
        try {
            int _type = PROTECTED;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:101:11: ( 'protected' )
            // ../etc/Java.g:101:13: 'protected'
            {
            match("protected"); 
    ...
    traceIn("PUBLIC", 84);
        try {
            int _type = PUBLIC;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:102:8: ( 'public' )
            // ../etc/Java.g:102:10: 'public'
            {
            match("public"); 
    ...
    traceIn("RETURN", 85);
        try {
            int _type = RETURN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:103:8: ( 'return' )
            // ../etc/Java.g:103:10: 'return'
            {
            match("return"); 
    ...
    traceIn("SHORT", 86);
        try {
            int _type = SHORT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:104:7: ( 'short' )
            // ../etc/Java.g:104:9: 'short'
            {
            match("short"); 
    ...
    traceIn("STATIC", 87);
        try {
            int _type = STATIC;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:105:8: ( 'static' )
            // ../etc/Java.g:105:10: 'static'
            {
            match("static"); 
    ...
    traceIn("STRICTFP", 88);
        try {
            int _type = STRICTFP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:106:10: ( 'strictfp' )
            // ../etc/Java.g:106:12: 'strictfp'
            {
            match("strictfp"); 
    ...
    traceIn("SUPER", 89);
        try {
            int _type = SUPER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:107:7: ( 'super' )
            // ../etc/Java.g:107:9: 'super'
            {
            match("super"); 
    ...
    traceIn("SWITCH", 90);
        try {
            int _type = SWITCH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:108:8: ( 'switch' )
            // ../etc/Java.g:108:10: 'switch'
            {
            match("switch"); 
    ...
    traceIn("SYNCHRONIZED", 91);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:109:14: ( 'synchronized' )
            // ../etc/Java.g:109:16: 'synchronized'
            {
            match("synchronized"); 
    ...
    traceIn("THIS", 92);
        try {
            int _type = THIS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:110:6: ( 'this' )
            // ../etc/Java.g:110:8: 'this'
            {
            match("this"); 
    ...
    traceIn("THROW", 93);
        try {
            int _type = THROW;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:111:7: ( 'throw' )
            // ../etc/Java.g:111:9: 'throw'
            {
            match("throw"); 
    ...
    traceIn("THROWS", 94);
        try {
            int _type = THROWS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:112:8: ( 'throws' )
            // ../etc/Java.g:112:10: 'throws'
            {
            match("throws"); 
    ...
    traceIn("TRANSIENT", 95);
        try {
            int _type = TRANSIENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:113:11: ( 'transient' )
            // ../etc/Java.g:113:13: 'transient'
            {
            match("transient"); 
    ...
    traceIn("TRUE", 96);
        try {
            int _type = TRUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:114:6: ( 'true' )
            // ../etc/Java.g:114:8: 'true'
            {
            match("true"); 
    ...
    traceIn("TRY", 97);
        try {
            int _type = TRY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:115:5: ( 'try' )
            // ../etc/Java.g:115:7: 'try'
            {
            match("try"); 
    ...
    traceIn("VOID", 98);
        try {
            int _type = VOID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:116:6: ( 'void' )
            // ../etc/Java.g:116:8: 'void'
            {
            match("void"); 
    ...
    traceIn("VOLATILE", 99);
        try {
            int _type = VOLATILE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:117:10: ( 'volatile' )
            // ../etc/Java.g:117:12: 'volatile'
            {
            match("volatile"); 
    ...
    traceIn("WHILE", 100);
        try {
            int _type = WHILE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:118:7: ( 'while' )
            // ../etc/Java.g:118:9: 'while'
            {
            match("while"); 
    ...
    traceIn("HEX_LITERAL", 101);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1083:13: ( '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )? )
            // ../etc/Java.g:1083:15: '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )?
            {
            match('0'); 
            ...
            // ../etc/Java.g:1083:40: ( INTEGER_TYPE_SUFFIX )?
            int alt2=2;
    ...
    traceIn("DECIMAL_LITERAL", 102);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1085:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )? )
            // ../etc/Java.g:1085:19: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )?
            {
            // ../etc/Java.g:1085:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ../etc/Java.g:1085:26: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // ../etc/Java.g:1085:35: ( '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
            ...
            // ../etc/Java.g:1085:46: ( INTEGER_TYPE_SUFFIX )?
            int alt5=2;
    ...
    traceIn("OCTAL_LITERAL", 103);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1087:15: ( '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )? )
            // ../etc/Java.g:1087:17: '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )?
            {
            match('0'); 
            // ../etc/Java.g:1087:21: ( '0' .. '7' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
            ...
            // ../etc/Java.g:1087:33: ( INTEGER_TYPE_SUFFIX )?
            int alt7=2;
    ...
    traceIn("HEX_DIGIT", 104);
        try {
            // ../etc/Java.g:1090:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // ../etc/Java.g:1090:13: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    traceIn("INTEGER_TYPE_SUFFIX", 105);
        try {
            // ../etc/Java.g:1093:21: ( ( 'l' | 'L' ) )
            // ../etc/Java.g:1093:23: ( 'l' | 'L' )
            {
    ...
    traceIn("FLOATING_POINT_LITERAL", 106);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1096:5: ( ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX ) | DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // ../etc/Java.g:1096:9: ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                    {
                    // ../etc/Java.g:1096:9: ( '0' .. '9' )+
                    int cnt8=0;
                    loop8:
                    do {
                        int alt8=2;
                    ...
                    // ../etc/Java.g:1097:9: ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                    int alt13=3;
                    switch ( input.LA(1) ) {
                    case '.':
                        {
                    ...
                    switch (alt13) {
                        case 1 :
                            // ../etc/Java.g:1098:13: DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                            {
                            mDOT(); 
                            // ../etc/Java.g:1098:17: ( '0' .. '9' )*
                            loop9:
                            do {
                                int alt9=2;
                            ...
                            // ../etc/Java.g:1098:39: ( FLOAT_TYPE_SUFFIX )?
                            int alt11=2;
                            ...
                            break;
                        case 2 :
                            // ../etc/Java.g:1099:13: EXPONENT ( FLOAT_TYPE_SUFFIX )?
                            {
                            mEXPONENT(); 
                            // ../etc/Java.g:1099:22: ( FLOAT_TYPE_SUFFIX )?
                            int alt12=2;
                            ...
                            break;
                        case 3 :
                            // ../etc/Java.g:1100:13: FLOAT_TYPE_SUFFIX
                            {
                            mFLOAT_TYPE_SUFFIX(); 
                    ...
                    break;
                case 2 :
                    // ../etc/Java.g:1102:9: DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                    {
                    mDOT(); 
                    // ../etc/Java.g:1102:13: ( '0' .. '9' )+
                    int cnt14=0;
                    loop14:
                    do {
                        int alt14=2;
                    ...
                    // ../etc/Java.g:1102:35: ( FLOAT_TYPE_SUFFIX )?
                    int alt16=2;
    ...
    traceIn("EXPONENT", 107);
        try {
            // ../etc/Java.g:1106:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // ../etc/Java.g:1106:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    traceIn("FLOAT_TYPE_SUFFIX", 108);
        try {
            // ../etc/Java.g:1109:19: ( ( 'f' | 'F' | 'd' | 'D' ) )
            // ../etc/Java.g:1109:21: ( 'f' | 'F' | 'd' | 'D' )
            {
    ...
    traceIn("CHARACTER_LITERAL", 109);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1112:5: ( '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            // ../etc/Java.g:1112:9: '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
            match('\''); 
            // ../etc/Java.g:1112:14: ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) )
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // ../etc/Java.g:1112:16: ESCAPE_SEQUENCE
                    {
                    mESCAPE_SEQUENCE(); 
    ...
    traceIn("STRING_LITERAL", 110);
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1116:5: ( '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"' )
            // ../etc/Java.g:1116:8: '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // ../etc/Java.g:1116:12: ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )*
            loop21:
            do {
                int alt21=3;
                ...
                switch (alt21) {
            	case 1 :
            	    // ../etc/Java.g:1116:14: ESCAPE_SEQUENCE
            	    {
            	    mESCAPE_SEQUENCE(); 
    ...
    traceIn("ESCAPE_SEQUENCE", 111);
        try {
            // ../etc/Java.g:1121:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESCAPE | OCTAL_ESCAPE )
            int alt22=3;
            ...
            switch (alt22) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ../etc/Java.g:1122:9: UNICODE_ESCAPE
                    {
                    mUNICODE_ESCAPE(); 
                    ...
                    break;
                case 3 :
                    // ../etc/Java.g:1123:9: OCTAL_ESCAPE
                    {
                    mOCTAL_ESCAPE(); 
    ...
    traceIn("OCTAL_ESCAPE", 112);
        try {
            // ../etc/Java.g:1128:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt23=3;
            ...
            switch (alt23) {
                case 1 :
                    // ../etc/Java.g:1128:9: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    {
                    match('\\'); 
                    // ../etc/Java.g:1128:14: ( '0' .. '3' )
                    // ../etc/Java.g:1128:15: '0' .. '3'
                    {
                    matchRange('0','3'); 

                    }

                    // ../etc/Java.g:1128:25: ( '0' .. '7' )
                    // ../etc/Java.g:1128:26: '0' .. '7'
                    {
                    matchRange('0','7'); 

                    }

                    // ../etc/Java.g:1128:36: ( '0' .. '7' )
                    // ../etc/Java.g:1128:37: '0' .. '7'
                    {
                    matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // ../etc/Java.g:1129:9: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    {
                    match('\\'); 
                    // ../etc/Java.g:1129:14: ( '0' .. '7' )
                    // ../etc/Java.g:1129:15: '0' .. '7'
                    {
                    matchRange('0','7'); 

                    }

                    // ../etc/Java.g:1129:25: ( '0' .. '7' )
                    // ../etc/Java.g:1129:26: '0' .. '7'
                    {
                    matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // ../etc/Java.g:1130:9: '\\\\' ( '0' .. '7' )
                    {
                    match('\\'); 
                    // ../etc/Java.g:1130:14: ( '0' .. '7' )
                    // ../etc/Java.g:1130:15: '0' .. '7'
                    {
                    matchRange('0','7'); 
    ...
    traceIn("UNICODE_ESCAPE", 113);
        try {
            // ../etc/Java.g:1135:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            // ../etc/Java.g:1135:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            {
            match('\\'); 
            match('u'); 
            mHEX_DIGIT(); 
    ...
    traceIn("IDENT", 114);
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1139:5: ( JAVA_ID_START ( JAVA_ID_PART )* )
            // ../etc/Java.g:1139:9: JAVA_ID_START ( JAVA_ID_PART )*
            {
            mJAVA_ID_START(); 
            // ../etc/Java.g:1139:23: ( JAVA_ID_PART )*
            loop24:
            do {
                int alt24=2;
                ...
                switch (alt24) {
            	case 1 :
            	    // ../etc/Java.g:1139:24: JAVA_ID_PART
            	    {
            	    mJAVA_ID_PART(); 
    ...
    traceIn("JAVA_ID_START", 115);
        try {
            // ../etc/Java.g:1144:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // ../etc/Java.g:
            {
    ...
    traceIn("JAVA_ID_PART", 116);
        try {
            // ../etc/Java.g:1161:5: ( JAVA_ID_START | '\\u0030' .. '\\u0039' )
            // ../etc/Java.g:
            {
    ...
    traceIn("COMMENT", 118);
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../etc/Java.g:1176:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // ../etc/Java.g:1176:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // ../etc/Java.g:1176:14: ( options {greedy=false; } : . )*
            loop25:
            do {
                int alt25=2;
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt28) {
            ...
            case 4 :
                ...
                break;
            case 5 :
                // ../etc/Java.g:1:35: BIT_SHIFT_RIGHT
                {
                mBIT_SHIFT_RIGHT(); 
                ...
                break;
            case 6 :
                // ../etc/Java.g:1:51: BIT_SHIFT_RIGHT_ASSIGN
                {
            ...
            case 15 :
                ...
                break;
            case 16 :
                // ../etc/Java.g:1:132: GREATER_OR_EQUAL
                {
                mGREATER_OR_EQUAL(); 
            ...
            case 20 :
                ...
                break;
            case 21 :
                // ../etc/Java.g:1:180: LESS_OR_EQUAL
                {
                mLESS_OR_EQUAL(); 
            ...
            case 42 :
                ...
                break;
            case 43 :
                // ../etc/Java.g:1:370: SHIFT_LEFT_ASSIGN
                {
                mSHIFT_LEFT_ASSIGN(); 
            ...
            case 44 :
                ...
                break;
            case 45 :
                // ../etc/Java.g:1:400: SHIFT_RIGHT_ASSIGN
                {
                mSHIFT_RIGHT_ASSIGN(); 
            ...
            case 101 :
                ...
                break;
            case 102 :
                // ../etc/Java.g:1:807: DECIMAL_LITERAL
                {
                mDECIMAL_LITERAL(); 
                ...
                break;
            case 103 :
                // ../etc/Java.g:1:823: OCTAL_LITERAL
                {
                mOCTAL_LITERAL(); 
                ...
                break;
            case 104 :
                // ../etc/Java.g:1:837: FLOATING_POINT_LITERAL
                {
                ...
                break;
            case 105 :
                // ../etc/Java.g:1:860: CHARACTER_LITERAL
                {
                mCHARACTER_LITERAL(); 
                ...
                break;
            case 106 :
                // ../etc/Java.g:1:878: STRING_LITERAL
                {
                mSTRING_LITERAL(); 
